...
namespace TeacherAttendance.model
{
    class AttendanceManagement
    {
        ...
        public void addNewAttendance(int teacherId, int courseId, int RoomId, string startTime, string leaveTime, string comment)
        {
            attendance.Add(new Attendance(teacherId,courseId,RoomId,startTime,leaveTime,comment));
        }
